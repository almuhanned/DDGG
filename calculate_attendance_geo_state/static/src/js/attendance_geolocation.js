odoo.define('calculate_attendance_geo_state.attendances_geolocation', function (require) {
    "use strict";
...
//            };
//            if (navigator.geolocation) {
//                console.log("kkkkkkkkkkkkkkkkkkk222222222222222");
//                if (navigator.geolocation.getCurrentPosition(self._manual_attendance.bind(self), self._getPositionError, options)){
//                    navigator.geolocation.getCurrentPosition(self._manual_attendance.bind(self), self._getPositionError, options);
//                }
//                else{
//                    console.log("locaaaaaaaaaation");
//                    this._rpc({
//                    model: 'hr.employee',
//                    method: 'attendance_manual',
...
//        },
//        _getPositionError: function (error) {
//            Dialog.alert(this,"Error:"+error.code+" "+error.message+" Run Your GPS");
//            console.warn('ERROR(${error.code}): ${error.message}');
//        },
//    });
//
