...
class AttendanceSheetBatch(models.Model):
    ...
    department_id = fields.Many2one('hr.department', 'Department Name', required=False)
    department_ids = fields.Many2many('hr.department', 'department_id', 'sheet_batch_id', 'departments_batch_sheet_rel', 'Departments', required=True)
    ...
    def onchange_employee(self):
        ...
        self.name = _('Attendance Batch of Departments for %s') % (
    ...
    def gen_att_sheet(self):
        ...
        for batch in self:
            ...
            employee_ids = self.env['hr.employee'].search([('department_id', '=', batch.department_ids.ids)])
