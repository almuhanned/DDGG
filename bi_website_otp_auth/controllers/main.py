...
from odoo.addons.web.controllers.main import ensure_db, Home, set_cookie_and_redirect, login_and_redirect
    ...
    def web_login(self, redirect=None, **kw):
        ...
        if 'otp_type' in request.params:
            ...
            if otp_obj and 'password' in request.params and otp_obj.name == request.params['password']:
                ...
                resp = login_and_redirect(request.session.db, request.params['login'], otp_obj.otp_name, redirect_url=url)
